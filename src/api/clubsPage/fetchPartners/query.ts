...
const getClubsPartnersReferenceDataQuery = defineQuery(`
*[_type == "partner"] {
  _id,
  name
}
...
export async function fetchPartnersReferenceData(): Promise<GetPartnersReferenceDataQueryResult> {
    const result = await fetchSanity<GetPartnersReferenceDataQueryResult>(getClubsPartnersReferenceDataQuery);
